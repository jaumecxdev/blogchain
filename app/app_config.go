...
import (
	...
	blogchainmodulev1 "blogchain/api/blogchain/blogchain/module"
	_ "blogchain/x/blogchain/module" // import for side-effects
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			},
			{
				...
				Config: appconfig.WrapAny(&blogchainmodulev1.Module{}),
			},
